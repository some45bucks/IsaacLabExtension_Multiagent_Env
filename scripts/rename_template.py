...
It renames all the occurrences of Multiagent_Env (in files, directories, etc.) to the new project name.
"""
...
if __name__ == "__main__":
    ...
    if proceed.lower() == "y":
        # rename the Multiagent_Env folder
        os.rename(
            os.path.join(root_dir_path, "exts", "Multiagent_Env", "Multiagent_Env"),
            os.path.join(root_dir_path, "exts", "Multiagent_Env", new_name),
        )
        os.rename(os.path.join(root_dir_path, "exts", "Multiagent_Env"), os.path.join(root_dir_path, "exts", new_name))
